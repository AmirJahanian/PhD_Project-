...
for ag=1:length(Age_Group)
    for ft=1:length(Feedback_Type)
        ...
        data(index).Feedback_Type = Feedback_Type(ft);
        data(index).Odata = [];
        data(index).Pdata = [];
        data(index).Fdata = [];
        data(index).Cdata = [];
...
for line=1:length(data)
    data(line).freqs = table2array(T(table2array(T(:,1)) == data(line).Age_Group & table2array(T(:,2)) == data(line).Feedback_Type,3));
    data(line).Odata = table2array(T(table2array(T(:,1)) == data(line).Age_Group & table2array(T(:,2)) == data(line).Feedback_Type,7));
    data(line).Pdata = table2array(T(table2array(T(:,1)) == data(line).Age_Group & table2array(T(:,2)) == data(line).Feedback_Type,6));
    data(line).Cdata = table2array(T(table2array(T(:,1)) == data(line).Age_Group & table2array(T(:,2)) == data(line).Feedback_Type,5));
    data(line).Fdata = table2array(T(table2array(T(:,1)) == data(line).Age_Group  & table2array(T(:,2)) == data(line).Feedback_Type,4));
end
